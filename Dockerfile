...
RUN case "${EXTRACTION_CANDIDATE_STRATEGY}" in \
      current|interaction-slim|evidence-fidelity-v1|source-clause-v1|source-clause-implicit-state-v1|typed-2|source-span-v1|source-span-v2|claim-card-v1|claim-card-v2) ;; \
