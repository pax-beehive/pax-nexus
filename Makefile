...
EXTRACTION_CANDIDATE_STRATEGIES := current interaction-slim evidence-fidelity-v1 typed-2 source-span-v1 source-span-v2 claim-card-v1 claim-card-v2
...
validate-extraction-candidate-strategy:
	@case "$(EXTRACTION_CANDIDATE_STRATEGY)" in current|interaction-slim|evidence-fidelity-v1|typed-2|source-span-v1|source-span-v2|claim-card-v1|claim-card-v2) ;; \
