...
service PageWikiService {
  ...
  CurrentPageResponse GetPage(1: PageBySlugRequest request) (api.get="/pages/:slug")
  PageRevisionList ListPageRevisions(1: PageBySlugRequest request) (api.get="/pages/:slug/revisions")
  PageRevision GetPageRevision(1: PageRevisionRequest request) (api.get="/pages/:slug/revisions/:revision")
  PageLinksResponse GetPageBacklinks(1: PageBySlugRequest request) (api.get="/pages/:slug/backlinks")
  SearchResponse Search(1: SearchRequest request) (api.get="/search")
