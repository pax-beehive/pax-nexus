...
type Config struct {
	...
	ProtocolMetadata map[string]string   `json:"protocol_metadata,omitempty" yaml:"-"`
...
type Case struct {
	...
	KnowledgeSourceStatus string   `json:"knowledge_source_status,omitempty"`
...
type TrialResult struct {
	...
	MemoryRecallObserved      bool           `json:"memory_recall_observed"`
