...
// @router /v1/knowledge-eval/experiment-tasks/:task_id/cancel [POST]
func CancelExperimentTask(ctx context.Context, c *app.RequestContext) {
	...
	handler.CancelExperimentTask(ctx, c, &req)
}
