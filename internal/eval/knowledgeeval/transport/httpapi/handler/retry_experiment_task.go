...
// RetryExperimentTask .
// @router /v1/knowledge-eval/experiment-tasks/:task_id/retry [POST]
func RetryExperimentTask(ctx context.Context, c *app.RequestContext) {
	...
	handler.RetryExperimentTask(ctx, c, &req)
}
