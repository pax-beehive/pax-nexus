...
// @router /v1/knowledge-eval/experiment-tasks [POST]
func CreateExperimentTask(ctx context.Context, c *app.RequestContext) {
	...
	handler.CreateExperimentTask(ctx, c, &req)
}
