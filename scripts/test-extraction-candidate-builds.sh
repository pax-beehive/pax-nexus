...
for strategy in interaction-slim source-clause-v1 source-span-v1 source-span-v2 claim-card-v2; do
...
for strategy in unknown current typed-2 "interaction-slim typed-2"; do
