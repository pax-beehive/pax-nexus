...
export MEM0_DEEPSEEK_BASE_URL MEM0_EVAL_USER_ID MEM0_EVAL_AGENT_ID MEM0_SCORE_SEMANTICS MEM0_SEARCH_SCOPE_PAYLOAD PAXM_EXPECTED_VERSION PAXM_PASSIVE_MIN_RELEVANCE PAXM_PASSIVE_MIN_SCORE PAXM_INSERTION_MIN_SCORE PAXM_EVAL_DIAGNOSTICS
